Fill this in with a description of what should be done to pass this exercise. For example, write a program that prints the text "basic" to the console (stdout).
